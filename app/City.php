...
class City extends Authenticatable
{
    ...
    */
    ...
    public function addNew($data,$type)
    {
        ...
        $add->min_price      =  isset($data['min_price']) ? $data['min_price'] : 0; // precio por minutos
        $add->wait_time_price = isset($data['wait_time_price']) ? $data['wait_time_price'] : 0; // precio por tiempo de espera
