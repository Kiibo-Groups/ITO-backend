                        ...
                        <div class="table-responsive">
                            <table id="example" class="table mb-0" style="width:100%">
                                <thead class="table-dark">
                                    <tr>
                                        <th>Nombre</th>
                                        <th>Precio por minutos</th>
                                        <th>Distancia Min / Máx</th>
                                        <th>Cobro por viajes</th>
                                        <th>Estado</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%">{{ $row->min_price }}</td>
                                        <td width="10%">{{$row->min_distance  . 'KM / ' .$row->max_distance }} KM</td>
